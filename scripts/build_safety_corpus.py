...
def collect_provenance(
    ...
    uv_version = uv_release_version(uv_output)
    if uv_version != EXPECTED_UV:
        raise TierCContractError(f"canonical builder requires uv {EXPECTED_UV}")
    ...
    return SafetyCorpusProvenance.model_validate(
        {
            ...
            "logical_freeze_sha256": logical_freeze_sha256,
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="ssi-safety-source-") as temporary:
            ...
            logical_freeze_sha256 = verify_logical_freeze(
                verified.entries,
                logical_freeze,
    ...
    print(
        ...
        f"logical_freeze={provenance.logical_freeze_sha256}, "
